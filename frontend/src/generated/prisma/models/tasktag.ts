...
export type tasktagWhereInput = {
  ...
  task_id?: Prisma.UuidFilter<"tasktag"> | string
  tag_id?: Prisma.UuidFilter<"tasktag"> | string
...
export type tasktagWhereUniqueInput = Prisma.AtLeast<{
  task_id_tag_id?: Prisma.tasktagTask_idTag_idCompoundUniqueInput
  AND?: Prisma.tasktagWhereInput | Prisma.tasktagWhereInput[]
  OR?: Prisma.tasktagWhereInput[]
  NOT?: Prisma.tasktagWhereInput | Prisma.tasktagWhereInput[]
  task_id?: Prisma.UuidFilter<"tasktag"> | string
...
export type tasktagScalarWhereWithAggregatesInput = {
  ...
  task_id?: Prisma.UuidWithAggregatesFilter<"tasktag"> | string
  tag_id?: Prisma.UuidWithAggregatesFilter<"tasktag"> | string
}
...
export type tasktagOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"task_id" | "tag_id", ExtArgs["result"]["tasktag"]>
...
export interface tasktagDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const tasktagWithTask_idOnly = await prisma.tasktag.findMany({ select: { task_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Tasktags and only return the `task_id`
   * const tasktagWithTask_idOnly = await prisma.tasktag.createManyAndReturn({
   *   select: { task_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Tasktags and only return the `task_id`
   * const tasktagWithTask_idOnly = await prisma.tasktag.updateManyAndReturn({
   *   select: { task_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface tasktagFieldRefs {
  readonly task_id: Prisma.FieldRef<"tasktag", 'String'>
  readonly tag_id: Prisma.FieldRef<"tasktag", 'String'>
}
