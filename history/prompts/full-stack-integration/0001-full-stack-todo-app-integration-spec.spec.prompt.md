---
id: "PHR-0001"
title: "Full-Stack Todo App Integration Spec"
stage: "spec"
date: "2026-01-12"
surface: "agent"
...
user: "unknown"
command: "/sp.specify"
labels: ["integration", "full-stack", "todo-app", "specification"]
links:
  spec: null
  ticket: null
  adr: null
  pr: null
files:
  - "specs/1-full-stack-integration/spec.md"
  - "specs/1-full-stack-integration/checklists/requirements.md"
tests: []
---
...
If the user provided a task/question in --title "Frontend Auth Route Resolution" --stage general --json:
...
- `{{PROMPT_TEXT}}` → **THE COMPLETE --title "Frontend Auth Route Resolution" --stage general --json TEXT VERBATIM** (do NOT truncate to first line!)
...
**CRITICAL**: `{{PROMPT_TEXT}}` MUST be the FULL multiline user input from --title "Frontend Auth Route Resolution" --stage general --json above, not just the title or first line.
...
## RESPONSE_TEXT
Created comprehensive specification for full-stack todo app integration connecting frontend to backend API with real data, authentication, and all features working end-to-end.

## OUTCOME_IMPACT
Successfully created detailed specification document outlining requirements for integrating frontend and backend systems, including user scenarios, functional requirements, and success criteria for the full-stack todo application.
...
## NEXT_PROMPTS
/sp.plan - Create implementation plan for the full-stack integration
/sp.tasks - Generate detailed tasks for implementation

## REFLECTION_NOTE
The specification clearly defines the integration requirements between frontend and backend systems, establishing clear success criteria for the full-stack todo application.
